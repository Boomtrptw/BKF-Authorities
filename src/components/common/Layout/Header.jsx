    ...
    <div className="header">
      <div className="header-container">
        <div className="header-left">
          ...
          <div className="menu-toggle" onClick={() => setShowSidebarMenu(!showSidebarMenu)}>
        ...
        <div className="header-right">
          ...
          <div className="dropdown dropdown-header">
            <div className="cursor-pointer" onClick={() => toggleDropdown('bookmark')}>
          ...
          <div className="dropdown dropdown-header">
            <div className="relative cursor-pointer" onClick={() => toggleDropdown('notification')}>
              <FaBell className="text-white text-2xl cursor-pointer" />
              { notification.length > 0 && <div className="notification-warning"></div> }
            </div>
            { openDropdown === "notification" && (
              <div className="dropdown-content notification-content">
                <div className="notification-head">
                  Notification
                  <div className="notification-count">{notification.length}</div>
                </div>
                    ...
                    { notification.length > 0 && notification.map((item,index) => (
                      <li key={index}>
                        <Link to={item.notificationLink}>
                          ...
                          <div>
                            <p className="font-bold">{item.notificationUser}</p>
          ...
          <div className="dropdown dropdown-header">
            <div className="header-user cursor-pointer" onClick={() => toggleDropdown('userMenu')}>
              <div className="user-photo">
                <img alt="" src={UserPhoto} />
              </div>
              <div className="user-info">
                <p className="text-white text-sm font-semibold mb-2">Pongsakorn Boonraksa</p>
                <p className="text-white text-xs mb-0">UX/UI Designer</p>
              </div>
            ...
            { openDropdown === "userMenu" && (
              <ul className="dropdown-content user-content">
                ...
                <li>
                  <Link to="/"><span className="text-red">Logout</span></Link>
                </li>
              </ul>
            )}
          </div>
