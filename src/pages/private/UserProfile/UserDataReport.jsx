...
import { userDataReport } from "../../../data/security";
...
const UserDataReport = () => {
  ...
  const filterUserDataReport = userDataReport.filter(item => {
    return (
    ...
    <div className="box-container">
      ...
      <div className="container-head has-content-between flex-wrap">
        <div className="title-left">
          <PageTitle title="User Data Report" code="VRI-SC" />
        </div>
          ...
          <table className="table-list min-w-1280">
            <thead>
              <tr>
                ...
                <th className="text-center" style={{ width: "150px", maxWidth: "150px" }}>Function ID</th>
                <th className="text-center" style={{ width: "200px", maxWidth: "200px" }}>Function Name</th>
            ...
            <tbody>
              { toggleData && filterUserDataReport.length > 0 ? (
                filterUserDataReport.map((employee) =>
                    ...
                    sessions.map((session, sessionIndex) => {
                      ...
                      return (
                        <tr key={`${employee.employeeId}-${date}-${session.session}`}>
                          ...
                          <td className={clsx("text-center", { "no-border-bottom": !isLastRowOfEmployee })}>{session.functionId}</td>
                          <td className={clsx("text-center", { "no-border-bottom": !isLastRowOfEmployee })}>{session.functionName}</td>
                          <td className={clsx("text-center", { "no-border-bottom": !isLastRowOfEmployee })}>{session.functionDetail}</td>
